...
class IncomingMessageLoggerTest {
    ...
    class BasicFunctionality {
        ...
        void shouldHideHeadersWhenHeaderLoggingDisabled() {
            incomingProps.setLogHeaders(false);
            processor = new IncomingMessageLogger(incomingProps);
    ...
    class ContentTypes {
        ...
        void shouldNotLogBodyIfContentTypeIsNotReadable(String contentType, String expectedContentType) {
            ...
            String expectedLogMessage = String.format(
                "INCOMING Message - Exchange: 'null', RoutingKey: 'null', ContentType: '%s', Headers: {}, Body: <Non-readable body>",
                expectedContentType);
            assertThat(debugEvent.getFormattedMessage()).isEqualTo(expectedLogMessage);
        }
        ...
        void shouldLogBodyWithReadableContentTypes(String contentType) {
            ...
            String expectedLogMessage = String.format(
                "INCOMING Message - Exchange: 'null', RoutingKey: 'null', ContentType: '%s', Headers: {}, Body: %s",
    ...
    class CharacterEncoding {
        ...
        void shouldHandleDecodingFailure() {
            ...
            assertThat(actualLogMessage).startsWith("INCOMING Message - Exchange: 'null', RoutingKey: 'null', ContentType: 'text/plain', Headers: {}, Body: ");
        }
